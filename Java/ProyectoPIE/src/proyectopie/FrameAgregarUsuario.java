...
FrameMenuAdmin frame = new FrameMenuAdmin(); 
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
             st.executeUpdate("INSERT INTO usuario (nombre_usuario, pass, tipo_usuario , nombre_completo_usuario,estado) VALUES ('" + usuario +"', '" + contraseña +"', '" + tipo_usuario +"' , '" + nombre_usuario +"','activo')");
