...
public class FrameEvaluacionParte5 extends javax.swing.JFrame {
    ...
    public static int id_del_curso;
    public static int id_de_ficha_diagnosstico;
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
     ...
     void select_id_curso(){
         try{
            String sql = "select id_curso from curso where nombre  = '" + jLabel27.getText() +"' ";
            ResultSet rs = con.ejecutarSQLSelect(sql);
            if (rs.next()){
                id_del_curso = rs.getInt("id_curso");
                rs.close();
            }
            else{
                rs.close();
    ...
    void select_id_ficha_diagnostico(){
        
         int tnumero_estudiante = Integer.parseInt(jLabel19.getText()); 
         
          
         try{
            String sql = "select id_fichadiagnostico from ficha_diagnostico where numero_estudiante = "+tnumero_estudiante+" and rut_alumno = '"+ jLabel24.getText() +"' and fecha_emision = '"+ jLabel33.getText() +"' and curso_alumno  = " + id_del_curso +"";
            ResultSet rs = con.ejecutarSQLSelect(sql);
            if (rs.next()){
                id_de_ficha_diagnosstico = rs.getInt("id_fichadiagnostico");
                rs.close();
            }else{
                rs.close();
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        select_id_curso();                     
        select_id_ficha_diagnostico();
        try {
            
            //JasperReport jr = JasperCompileManager.compileReport("C:/reportes para PIE/Reporte_Ficha.jrxml");
            JasperReport jr = (JasperReport) JRLoader.loadObject(getClass().getResource("Reportewp_Ficha.jasper"));
         //"C:\Users\56962\Documents\GitHub\integracion-pie\prueba reporte\ProyectoPIE\src\proyectopie\Reporte_Ficha.jrxml"
            ...
            Parametros.put("ParametroId",id_de_ficha_diagnosstico);
