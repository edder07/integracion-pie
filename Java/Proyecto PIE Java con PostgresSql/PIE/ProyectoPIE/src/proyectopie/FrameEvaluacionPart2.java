    ...
    void cargar_datos_combo_frame_recuperar(){
     ...
     void cargar_combo_ev5_activos() {
        ...
        try {
            ...
            String sql = "select profesional_evaluador.nombre_evaluador from profesional_evaluador ";
            ResultSet rs = con.ejecutarSQLSelect(sql);
            comboev1.removeAllItems();
  ...
  FrameEvaluacionPart1 frame = new FrameEvaluacionPart1(); 
    ...
    void obtener_datos_evaluador_combobox(){
        ...
        try {
            ...
            String sql = "select profesional_evaluador.rut_evaluador, profesional_evaluador.profesion , profesional_evaluador.id_evaluador from profesional_evaluador where profesional_evaluador.nombre_evaluador = '" + cev1 +"'";
            ResultSet rs = con.ejecutarSQLSelect(sql);
        ...
        try {
            ...
            String sql1 = "select profesional_evaluador.rut_evaluador, profesional_evaluador.profesion , profesional_evaluador.id_evaluador from profesional_evaluador where profesional_evaluador.nombre_evaluador = '" + cev2 +"'";
            ResultSet rs = con.ejecutarSQLSelect(sql1);
        ...
        try {
            ...
            String sql2 = "select profesional_evaluador.rut_evaluador, profesional_evaluador.profesion , profesional_evaluador.id_evaluador from profesional_evaluador where profesional_evaluador.nombre_evaluador = '" + cev3 +"'";
            ResultSet rs = con.ejecutarSQLSelect(sql2);
        ...
        try {
            ...
            String sql3 = "select profesional_evaluador.rut_evaluador, profesional_evaluador.profesion , profesional_evaluador.id_evaluador from profesional_evaluador where profesional_evaluador.nombre_evaluador = '" + cev4 +"'";
            ResultSet rs = con.ejecutarSQLSelect(sql3);
        ...
        try {
            ...
            String sql4 = "select profesional_evaluador.rut_evaluador, profesional_evaluador.profesion , profesional_evaluador.id_evaluador from profesional_evaluador where profesional_evaluador.nombre_evaluador = '" + cev5 +"'";
            ResultSet rs = con.ejecutarSQLSelect(sql4);
