...
Public Class Form1
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Try
            conector.Open()
            Dim qry As String = "select usuario.nombre_usuario , usuario.nombre_completo_usuario  from usuario where nombre_usuario = '" & txtuser.Text & "' and pass='" & txtpass.Text & "' and usuario.estado = 'activo'"
            Dim sqlcmd As New SqlCommand(qry, conector)
            Dim dr As SqlDataReader
            dr = sqlcmd.ExecuteReader
