...
Public Class Menu_Principal
    ...
    Dim servidorSQL As String = "DESKTOP-ONN8J9K"
    ...
    Private rptDoc As New CrystalReport1
    ...
    Private Sub Button16_Click(sender As System.Object, e As System.EventArgs) Handles Button16.Click
        ...
        Else
            ...
            If dr.Read() Then
                ...
                conector.Close()
                conector.Close()
                MsgBox("El Alumno Ya Fue Ingresado, si desea realizar algun cambio presione Modificar", MsgBoxStyle.Information, "Operacion Exitosa")
                conector.Close()
            Else
                Try
    ...
    Private Sub Button21_Click(sender As System.Object, e As System.EventArgs) Handles Button21.Click
        If (TextBox7.Text = "" Or TextBox8.Text = "" Or TextBox9.Text = "") Then
            MsgBox("Verifique campos en blanco", MsgBoxStyle.Critical, "Atencion")
            TextBox1.Select()
            conector.Close()
        Else
            conector.Close()
            ...
            If dr.Read() Then
                ...
                conector.Close()
                conector.Close()
                MsgBox("El Apoderado Ya Fue Ingresado, si desea realizar algun cambio presione Modificar", MsgBoxStyle.Information, "Operacion Exitosa")
                conector.Close()
            Else
                conector.Close()
                conector.Open()
    ...
    Private Sub Button25_Click(sender As System.Object, e As System.EventArgs) Handles Button25.Click
        Dim qry As String = "select profesional_apoyo.rut_apoyo from profesional_apoyo where profesional_apoyo.rut_apoyo ='" & TextBox12.Text & "'"
        Dim sqlcmd As New SqlCommand(qry, conector)
        conector.Open()
        Dim dr As SqlDataReader
        dr = sqlcmd.ExecuteReader
        If dr.Read() Then
            conector.Close()
            MsgBox("El Profesional Ya Fue Ingresado, si desea realizar algun cambio presione Modificar", MsgBoxStyle.Information, "Operacion Exitosa")
            conector.Close()
        Else
            Try
    ...
    Private Sub Button29_Click(sender As System.Object, e As System.EventArgs) Handles Button29.Click
        Dim qry As String = "select profesional_evaluador.rut_evaluador  from profesional_evaluador  where profesional_evaluador.rut_evaluador  ='" & TextBox14.Text & "'"
        Dim sqlcmd As New SqlCommand(qry, conector)
        Dim dr As SqlDataReader
        conector.Open()
        dr = sqlcmd.ExecuteReader
    ...
    Private Sub Button33_Click(sender As System.Object, e As System.EventArgs) Handles Button33.Click
        Dim qry As String = "select tipo_ficha.nombre_tipo from tipo_ficha where tipo_ficha.nombre_tipo ='" & TextBox17.Text & "'"
        Dim sqlcmd As New SqlCommand(qry, conector)
        conector.Open()
        Dim dr As SqlDataReader
        dr = sqlcmd.ExecuteReader
        If dr.Read() Then
            conector.Close()
            MsgBox("El Nombre del Diagnostico Ya Fue Ingresado, si desea realizar algun cambio presione Modificar", MsgBoxStyle.Information, "Operacion Exitosa")
            conector.Close()
        Else
            Try
    ...
    End Sub
    Sub MostrarEvaluador1Activos()
        conector.Close()
        conector.Open()
        Dim qry As String = "select profesional_evaluador.nombre_evaluador from profesional_evaluador where estado = 'activo'"
        Dim sqlcmd As New SqlCommand(qry, conector)
        'Dim drc As String
        Dim da As SqlDataAdapter = New SqlDataAdapter(sqlcmd)
        Dim ds As DataSet = New DataSet()
    ...
    Sub MostrarEvaluador5Activos()
        ...
        ComboBox7.SelectedIndex = 0
    End Sub
    Sub MostrarApoyo1Activos()
        conector.Close()
        conector.Open()
        Dim qry As String = "select profesional_apoyo.nombre_apoyo from profesional_apoyo where estado = 'activo'"
        Dim sqlcmd As New SqlCommand(qry, conector)
        'Dim drc As String
        Dim da As SqlDataAdapter = New SqlDataAdapter(sqlcmd)
        Dim ds As DataSet = New DataSet()
    ...
    Sub ConcatenoDePalabra()
        ...
        If CheckBox2.Checked = False And CheckBox1.Checked = False Then
            ConcatenoDeNuevoIngreso = TextBox18.Text
        End If
        If CheckBox3.Checked = False And CheckBox4.Checked = False Then
            ConcatenoDeAñoContinuidad = TextBox19.Text
        End If
        If CheckBox5.Checked = False And CheckBox6.Checked = False Then
            ConcatenoDeSindromeAsociadoAlDiagnostico = TextBox21.Text
        End If
    End Sub
    ...
    Private Sub Button36_Click(sender As System.Object, e As System.EventArgs) Handles Button36.Click
        If MonthCalendar2.SelectionRange.Start = SeleccionRutTipoFicha.Fechaemi Then
            MsgBox("No puede haber dos diagnostico en la misma fecha", MsgBoxStyle.Critical, "Atencion")
        Else
            ObtenerIdApoyo()
    ...
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        ...
        Report1.Zoom(70)
        CrystalReport1.DataSourceConnections(0).SetConnection(ipServidor, basededatos, usuarioBD, claveBD)
    ...
    Private Sub Button69_Click(sender As Object, e As EventArgs) Handles Button69.Click
        ...
        Try
            ...
            If dr.Read() Then
                ...
                MostrarEvaluador1Todos()
                MostrarEvaluador2Todos()
                MostrarEvaluador3Todos()
                MostrarEvaluador4Todos()
                MostrarEvaluador5Todos()
