    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Else
                ...
                Menu_Principal.MostrarApoyo1Activos()
                Menu_Principal.MostrarApoyo2Activos()
                Menu_Principal.MostrarApoyo3Activos()
                Menu_Principal.MostrarApoyo4Activos()

                Menu_Principal.MostrarEvaluador1Activos()
                Menu_Principal.MostrarEvaluador2Activos()
                Menu_Principal.MostrarEvaluador3Activos()
                Menu_Principal.MostrarEvaluador4Activos()
                Menu_Principal.MostrarEvaluador5Activos()
